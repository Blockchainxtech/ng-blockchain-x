...
@Component({
  selector: 'NgBx-connect-wallet',
  template: `
  <link rel="stylesheet" href="https://unpkg.com/flowbite@1.4.7/dist/flowbite.min.css" />
<!-- Main modal -->
<div *ngIf="connectWallet == true" id="crypto-modal" tabindex="-1" aria-hidden="true" class="flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
...
export class ConnectWalletComponent implements OnInit {
    ...
    @Input() connectWallet: boolean = false;
    constructor() { }
